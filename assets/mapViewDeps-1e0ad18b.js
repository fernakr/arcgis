import{g0 as Ie,lR as ae,eF as Ue,gK as $e,Y as q,lS as ke,lT as Le,lU as Ne,iC as He,lV as qe,lW as Ge,eI as x,ay as Ve,aK as Pe,M as Ce,eU as We,bV as K,eH as Z,e_ as Y,kI as je,eN as oe,eO as Ke,eL as Ye,k7 as Xe,k9 as Qe,eQ as le,hw as Je,ku as Ze,lX as et,lY as tt,s as it,kw as de,lZ as rt,_ as ue,kx as st,J as nt,eC as at,D as X,P as ot,aD as he,cS as lt,l_ as dt,ad as ce}from"./index-8a7d0ddb.js";import{c as ut}from"./ExpandedCIM-e2ecad80.js";import{p as ht,s as ct}from"./imageUtils-109ac031.js";import{t as _t,b as ft,o as _e,h as mt,i as pt}from"./Container-e3e1f850.js";import{i as gt}from"./BufferPool-42343b92.js";import{T as B,E as S,S as $}from"./color-66a81566.js";import{g as vt,a as L,h as G,w as A,d as bt,m as xt}from"./WGLContainer-ee25c10b.js";import{L as E}from"./enums-fb086c25.js";import{e as wt,a as W,f as ee}from"./ProgramTemplate-a8c46b04.js";import{n as U}from"./programUtils-77aa622f.js";import{e as fe,r as yt,t as Tt,a as Ft,m as Bt,J as Et,n as Ot,b as Rt,c as Mt}from"./MagnifierPrograms-4998fef8.js";import{d as is,y as rs}from"./MagnifierPrograms-4998fef8.js";import{h as te,E as C,a as ie,i as Pt}from"./FramebufferObject-bee5421c.js";import{R as v,E as H,F as re,O as j,I as Q,L as D,C as me,D as O,B as se,G as T,U as ne,P as Ct}from"./enums-bdecffa2.js";import{o as pe,N as St}from"./RenderingContext-a22df1a1.js";import{z as At,q as Dt,Q as zt,E as It,F as Ut,L as N,M as $t,_ as Se,R as ge}from"./definitions-181aacbc.js";import{t as ve}from"./VertexElementDescriptor-2925c6af.js";import{e as R,T as k}from"./Texture-276891d4.js";import{r as ns}from"./GraphicsView2D-2db00077.js";import{i as os}from"./GraphicContainer-da3bd512.js";import{t as be}from"./requestImageUtils-05ec4cf8.js";import"./BidiEngine-9a40f2f4.js";import"./visualVariablesUtils-f801a5b9.js";import"./OptimizedGeometry-d94e541f.js";import"./GeometryUtils-984e8446.js";import"./enums-f1a6a48a.js";import"./utils-c8352706.js";import"./GeometryUtils-a163e449.js";import"./Rect-ea14f53a.js";import"./quantizationUtils-d2ecb0cf.js";import"./floatRGBA-e76f1a93.js";import"./AttributeStoreView-e7acbf82.js";import"./TiledDisplayObject-a16a6043.js";import"./util-de2a9e3f.js";import"./StyleDefinition-29c49b98.js";import"./config-1337d16e.js";import"./earcut-7c5e4cbe.js";import"./featureConversionUtils-8b26ee93.js";import"./OptimizedFeatureSet-1d1ac4b9.js";import"./NestedMap-1b5db22e.js";import"./rasterizingUtils-b516be0f.js";import"./pbf-9deeeef5.js";import"./imageutils-f5fd29fb.js";import"./Matcher-d5690d71.js";import"./tileUtils-c2f19f52.js";import"./TurboLine-a929d0bb.js";import"./CircularArray-ef508845.js";import"./testSVGPremultipliedAlpha-bc185578.js";import"./throttle-7bf02de9.js";import"./ComputedAttributeStorage-ba05904c.js";import"./TimeOnly-a697da13.js";import"./OrderIndependentTransparency-6ae10952.js";import"./basicInterfaces-11f56cb3.js";import"./doublePrecisionUtils-e3c3d0d8.js";import"./normalizeUtilsSync-25fa9dd6.js";import"./projectionSupport-1ea9ed40.js";import"./json-48e3ea08.js";import"./BaseGraphicContainer-c8cae727.js";import"./FeatureContainer-ae205864.js";import"./TileContainer-e01d67f6.js";import"./vec3f32-2da9db36.js";let kt=class{constructor(){this._resourceMap=new Map,this._inFlightResourceMap=new Map,this.geometryEngine=null,this.geometryEnginePromise=null}destroy(){this._inFlightResourceMap.clear(),this._resourceMap.clear()}getResource(e){return this._resourceMap.get(e)??null}async fetchResource(e,t){const i=this._resourceMap.get(e);if(i)return{width:i.width,height:i.height};let r=this._inFlightResourceMap.get(e);return r?r.then(n=>({width:n.width,height:n.height})):(r=ht(e,t),this._inFlightResourceMap.set(e,r),r.then(n=>(this._inFlightResourceMap.delete(e),this._resourceMap.set(e,n),{width:n.width,height:n.height}),()=>({width:0,height:0})))}deleteResource(e){this._inFlightResourceMap.delete(e),this._resourceMap.delete(e)}loadFont(e){return ut(e)}},Lt=class{constructor(e){this.events=new Ie,this._hasMajorPerformanceCaveat=!1,this._lastRenderFrameCounter=0,this._canvas=document.createElement("canvas"),this._canvas.setAttribute("style","width: 100%; height:100%; display:block; willChange:transform");const t={failIfMajorPerformanceCaveat:!0,alpha:!0,antialias:!1,depth:!0,stencil:!0};e.appendChild(this._canvas);let i=ae("2d",this._canvas,t);i||(i=ae("2d",this._canvas,{...t,failIfMajorPerformanceCaveat:!1}),this._hasMajorPerformanceCaveat=!0),this._gl=i,this._handles=Ue([$e(this._canvas,"webglcontextlost",r=>this.events.emit("webgl-context-lost",r))])}destroy(){var e;(e=this._canvas.parentNode)==null||e.removeChild(this._canvas),this._canvas=null,this._handles.remove(),this._gl=null}get gl(){return this._gl}render(e,t){if(this._hasMajorPerformanceCaveat||q("esri-force-performance-mode")){if(++this._lastRenderFrameCounter>=q("esri-performance-mode-frames-between-render")&&(t(),this._lastRenderViewState=e.state.clone(),this._lastRenderFrameCounter=0),this._lastRenderViewState){const[i,r,n,s,a,o]=this._computeViewTransform(this._lastRenderViewState,e.state);this._canvas.style.transform=`matrix(${i}, ${r}, ${n}, ${s}, ${a}, ${o})`}}else t()}resize(e){const t=this._canvas,i=t.style,{state:{size:r},pixelRatio:n}=e,s=r[0],a=r[1],o=Math.round(s*n),d=Math.round(a*n);t.width===o&&t.height===d||(t.width=o,t.height=d),i.width=s+"px",i.height=a+"px"}_computeViewTransform(e,t){const[i,r]=e.center,[n,s]=t.center,[a,o]=e.toScreen([0,0],n,s),[d,u]=e.toScreen([0,0],i,r),h=d-a,_=u-o,m=e.scale/t.scale,g=t.rotation-e.rotation,f=Ge();return ke(f),Le(f,f,[m,m]),Ne(f,f,He(g)),qe(f,f,[h,_]),f}};const Nt={background:{"background.frag":`#ifdef PATTERN
