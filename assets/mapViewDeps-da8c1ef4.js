import{fY as Ie,lu as ae,eG as Ue,gT as $e,a1 as q,lv as ke,lw as Le,lx as Ne,ir as He,ly as qe,lz as Ge,eJ as x,az as Ve,aL as Pe,T as Ce,eV as We,a$ as K,eI as Z,f2 as Y,kj as je,eO as oe,eP as Ke,eM as Ye,jJ as Xe,jL as Je,eR as le,hw as Qe,k4 as Ze,lA as et,lB as tt,s as it,k6 as de,lC as rt,_ as ue,k7 as st,O as nt,eD as at,J as X,P as ot,aE as he,cY as lt,lD as dt,ae as ce}from"./index-12a23f8f.js";import{c as ut}from"./ExpandedCIM-f92b0e9f.js";import{p as ht,s as ct}from"./imageUtils-cb2425cf.js";import{t as _t,b as ft,o as _e,h as mt,i as pt}from"./Container-32966a35.js";import{i as gt}from"./BufferPool-f61e14f2.js";import{T as B,E as S,S as $}from"./color-64e9e29b.js";import{g as vt,a as L,h as G,w as A,d as bt,m as xt}from"./WGLContainer-61563beb.js";import{L as E}from"./enums-fb086c25.js";import{e as wt,a as W,f as ee}from"./ProgramTemplate-d6dd973d.js";import{n as U}from"./programUtils-3ed6a029.js";import{e as fe,r as yt,t as Tt,a as Ft,m as Bt,J as Et,n as Ot,b as Rt,c as Mt}from"./MagnifierPrograms-19f53628.js";import{d as is,y as rs}from"./MagnifierPrograms-19f53628.js";import{h as te,E as C,a as ie,i as Pt}from"./FramebufferObject-eafad06d.js";import{R as v,E as H,F as re,O as j,I as J,L as D,C as me,D as O,B as se,G as T,U as ne,P as Ct}from"./enums-bdecffa2.js";import{o as pe,N as St}from"./RenderingContext-21b3e0c6.js";import{z as At,q as Dt,Q as zt,E as It,F as Ut,L as N,M as $t,_ as Se,R as ge}from"./definitions-81a14670.js";import{t as ve}from"./VertexElementDescriptor-2925c6af.js";import{e as R,T as k}from"./Texture-112dea01.js";import{r as ns}from"./GraphicsView2D-98e7dd6d.js";import{i as os}from"./GraphicContainer-979e4f5d.js";import{t as be}from"./requestImageUtils-7382e14d.js";import"./BidiEngine-9a40f2f4.js";import"./visualVariablesUtils-90c2aed5.js";import"./OptimizedGeometry-d94e541f.js";import"./GeometryUtils-984e8446.js";import"./enums-f1a6a48a.js";import"./utils-9fb68141.js";import"./GeometryUtils-dd49d312.js";import"./Rect-ea14f53a.js";import"./quantizationUtils-84e07faa.js";import"./floatRGBA-c851a2c2.js";import"./AttributeStoreView-31552075.js";import"./TiledDisplayObject-f5f785fe.js";import"./util-9f2f1fb1.js";import"./StyleDefinition-29c49b98.js";import"./config-1337d16e.js";import"./earcut-930b2254.js";import"./featureConversionUtils-6e3aaf33.js";import"./OptimizedFeatureSet-1d1ac4b9.js";import"./NestedMap-1b5db22e.js";import"./rasterizingUtils-8c35cba3.js";import"./pbf-7ed7c749.js";import"./imageutils-766cfdc4.js";import"./Matcher-8d3f91b8.js";import"./tileUtils-c2f19f52.js";import"./TurboLine-df5ed9f4.js";import"./CircularArray-ef508845.js";import"./testSVGPremultipliedAlpha-cb89d143.js";import"./throttle-7bf02de9.js";import"./ComputedAttributeStorage-9f1e4ccf.js";import"./TimeOnly-09aefee7.js";import"./OrderIndependentTransparency-6ae10952.js";import"./basicInterfaces-11f56cb3.js";import"./doublePrecisionUtils-e3c3d0d8.js";import"./normalizeUtilsSync-2e514ea8.js";import"./projectionSupport-75a8a90e.js";import"./json-48e3ea08.js";import"./BaseGraphicContainer-7af58a16.js";import"./FeatureContainer-074590b8.js";import"./TileContainer-83f45892.js";import"./vec3f32-2da9db36.js";let kt=class{constructor(){this._resourceMap=new Map,this._inFlightResourceMap=new Map,this.geometryEngine=null,this.geometryEnginePromise=null}destroy(){this._inFlightResourceMap.clear(),this._resourceMap.clear()}getResource(e){return this._resourceMap.get(e)??null}async fetchResource(e,t){const i=this._resourceMap.get(e);if(i)return{width:i.width,height:i.height};let r=this._inFlightResourceMap.get(e);return r?r.then(n=>({width:n.width,height:n.height})):(r=ht(e,t),this._inFlightResourceMap.set(e,r),r.then(n=>(this._inFlightResourceMap.delete(e),this._resourceMap.set(e,n),{width:n.width,height:n.height}),()=>({width:0,height:0})))}deleteResource(e){this._inFlightResourceMap.delete(e),this._resourceMap.delete(e)}loadFont(e){return ut(e)}},Lt=class{constructor(e){this.events=new Ie,this._hasMajorPerformanceCaveat=!1,this._lastRenderFrameCounter=0,this._canvas=document.createElement("canvas"),this._canvas.setAttribute("style","width: 100%; height:100%; display:block; willChange:transform");const t={failIfMajorPerformanceCaveat:!0,alpha:!0,antialias:!1,depth:!0,stencil:!0};e.appendChild(this._canvas);let i=ae("2d",this._canvas,t);i||(i=ae("2d",this._canvas,{...t,failIfMajorPerformanceCaveat:!1}),this._hasMajorPerformanceCaveat=!0),this._gl=i,this._handles=Ue([$e(this._canvas,"webglcontextlost",r=>this.events.emit("webgl-context-lost",r))])}destroy(){var e;(e=this._canvas.parentNode)==null||e.removeChild(this._canvas),this._canvas=null,this._handles.remove(),this._gl=null}get gl(){return this._gl}render(e,t){if(this._hasMajorPerformanceCaveat||q("esri-force-performance-mode")){if(++this._lastRenderFrameCounter>=q("esri-performance-mode-frames-between-render")&&(t(),this._lastRenderViewState=e.state.clone(),this._lastRenderFrameCounter=0),this._lastRenderViewState){const[i,r,n,s,a,o]=this._computeViewTransform(this._lastRenderViewState,e.state);this._canvas.style.transform=`matrix(${i}, ${r}, ${n}, ${s}, ${a}, ${o})`}}else t()}resize(e){const t=this._canvas,i=t.style,{state:{size:r},pixelRatio:n}=e,s=r[0],a=r[1],o=Math.round(s*n),d=Math.round(a*n);t.width===o&&t.height===d||(t.width=o,t.height=d),i.width=s+"px",i.height=a+"px"}_computeViewTransform(e,t){const[i,r]=e.center,[n,s]=t.center,[a,o]=e.toScreen([0,0],n,s),[d,u]=e.toScreen([0,0],i,r),h=d-a,_=u-o,m=e.scale/t.scale,g=t.rotation-e.rotation,f=Ge();return ke(f),Le(f,f,[m,m]),Ne(f,f,He(g)),qe(f,f,[h,_]),f}};const Nt={background:{"background.frag":`#ifdef PATTERN
