import{gd as Ie,lS as ae,eM as Ue,h9 as $e,a1 as q,lT as ke,lU as Le,lV as Ne,id as He,lW as qe,lX as Ge,eO as x,au as Ve,aI as Me,T as Ce,eZ as We,aY as K,eN as Z,ff as Y,kz as je,eT as oe,eU as Ke,eR as Ye,jV as Xe,jX as Je,d4 as le,hN as Qe,kj as Ze,lY as et,lZ as tt,s as it,kl as de,l_ as rt,_ as ue,km as st,O as nt,eI as at,J as X,P as ot,aC as ce,cD as lt,l$ as dt,a9 as he}from"./index-3f4f2f72.js";import{i as ut}from"./CIMResourceManager-e70048fd.js";import{t as ct,a as ht,o as _e,h as _t,i as ft}from"./Container-36af1642.js";import{i as mt}from"./BufferPool-1f13a84e.js";import{T as B,E as S,S as $}from"./color-f45feb47.js";import{g as pt,a as L,h as G,w as A,d as gt,m as vt}from"./WGLContainer-9e17e7ce.js";import{L as E}from"./enums-fb086c25.js";import{e as bt,a as W,f as ee}from"./ProgramTemplate-4bdb7173.js";import{n as U}from"./programUtils-e1cc9786.js";import{e as fe,r as xt,t as wt,a as yt,m as Tt,J as Ft,n as Bt,b as Et,c as Ot}from"./MagnifierPrograms-e3095861.js";import{d as as,y as os}from"./MagnifierPrograms-e3095861.js";import{h as te,E as C,a as ie,i as Rt}from"./FramebufferObject-1bbb28fe.js";import{R as v,E as H,F as re,O as j,I as J,L as D,C as me,D as O,B as se,G as T,U as ne,P as Pt}from"./enums-bdecffa2.js";import{o as pe,N as Mt}from"./RenderingContext-1368cc60.js";import{z as Ct,q as St,Q as At,E as Dt,F as zt,L as N,M as It,_ as Se,R as ge}from"./definitions-90fc683e.js";import{t as ve}from"./VertexElementDescriptor-2925c6af.js";import{e as R,T as k}from"./Texture-d1bd8e31.js";import{s as Ut}from"./imageUtils-e5206020.js";import{r as ds}from"./GraphicsView2D-b08b2d83.js";import{i as cs}from"./GraphicContainer-239ff196.js";import{t as be}from"./requestImageUtils-835d8149.js";import"./fontUtils-1b1814c8.js";import"./AttributeStoreView-e0a9a73b.js";import"./TiledDisplayObject-dfd59b45.js";import"./visualVariablesUtils-202dad20.js";import"./cimAnalyzer-d2466652.js";import"./BidiEngine-9a40f2f4.js";import"./labelPoint-f2b94dc5.js";import"./OptimizedGeometry-196224d4.js";import"./GeometryUtils-984e8446.js";import"./enums-f1a6a48a.js";import"./alignmentUtils-ae955d28.js";import"./number-e491b09e.js";import"./Rect-ea14f53a.js";import"./quantizationUtils-b8c275a1.js";import"./floatRGBA-f1f0d7a4.js";import"./GeometryUtils-172b796e.js";import"./ExpandedCIM-38e0e9e3.js";import"./util-b46a3e55.js";import"./StyleDefinition-29c49b98.js";import"./config-1337d16e.js";import"./earcut-c94eb856.js";import"./featureConversionUtils-d6208516.js";import"./OptimizedFeature-e90b69df.js";import"./OptimizedFeatureSet-1d1ac4b9.js";import"./NestedMap-1b5db22e.js";import"./Rasterizer-a18cd5ef.js";import"./rasterizingUtils-239a56dc.js";import"./pbf-b7e567bf.js";import"./imageutils-028ab9b6.js";import"./Matcher-3854f034.js";import"./tileUtils-c2f19f52.js";import"./TurboLine-d8c698ed.js";import"./CircularArray-ef508845.js";import"./testSVGPremultipliedAlpha-e7642599.js";import"./throttle-7bf02de9.js";import"./ComputedAttributeStorage-c39c12f6.js";import"./TimeOnly-8013af30.js";import"./OrderIndependentTransparency-6ae10952.js";import"./basicInterfaces-11f56cb3.js";import"./doublePrecisionUtils-e3c3d0d8.js";import"./normalizeUtilsSync-99bcea57.js";import"./projectionSupport-7e613228.js";import"./json-48e3ea08.js";import"./BaseGraphicContainer-b8b978c7.js";import"./FeatureContainer-b0e73d75.js";import"./TileContainer-b14f110f.js";import"./vec3f32-2da9db36.js";let $t=class{constructor(e){this.events=new Ie,this._hasMajorPerformanceCaveat=!1,this._lastRenderFrameCounter=0,this._canvas=document.createElement("canvas"),this._canvas.setAttribute("style","width: 100%; height:100%; display:block; willChange:transform");const t={failIfMajorPerformanceCaveat:!0,alpha:!0,antialias:!1,depth:!0,stencil:!0};e.appendChild(this._canvas);let i=ae("2d",this._canvas,t);i||(i=ae("2d",this._canvas,{...t,failIfMajorPerformanceCaveat:!1}),this._hasMajorPerformanceCaveat=!0),this._gl=i,this._handles=Ue([$e(this._canvas,"webglcontextlost",r=>this.events.emit("webgl-context-lost",r))])}destroy(){var e;(e=this._canvas.parentNode)==null||e.removeChild(this._canvas),this._canvas=null,this._handles.remove(),this._gl=null}get gl(){return this._gl}render(e,t){if(this._hasMajorPerformanceCaveat||q("esri-force-performance-mode")){if(++this._lastRenderFrameCounter>=q("esri-performance-mode-frames-between-render")&&(t(),this._lastRenderViewState=e.state.clone(),this._lastRenderFrameCounter=0),this._lastRenderViewState){const[i,r,n,s,a,o]=this._computeViewTransform(this._lastRenderViewState,e.state);this._canvas.style.transform=`matrix(${i}, ${r}, ${n}, ${s}, ${a}, ${o})`}}else t()}resize(e){const t=this._canvas,i=t.style,{state:{size:r},pixelRatio:n}=e,s=r[0],a=r[1],o=Math.round(s*n),d=Math.round(a*n);t.width===o&&t.height===d||(t.width=o,t.height=d),i.width=s+"px",i.height=a+"px"}_computeViewTransform(e,t){const[i,r]=e.center,[n,s]=t.center,[a,o]=e.toScreen([0,0],n,s),[d,u]=e.toScreen([0,0],i,r),c=d-a,_=u-o,m=e.scale/t.scale,g=t.rotation-e.rotation,f=Ge();return ke(f),Le(f,f,[m,m]),Ne(f,f,He(g)),qe(f,f,[c,_]),f}};const kt={background:{"background.frag":`#ifdef PATTERN
