import{gd as Ie,lS as ae,eM as Ue,h9 as $e,a1 as q,lT as ke,lU as Le,lV as Ne,id as He,lW as qe,lX as Ge,eO as x,au as Ve,aI as Me,T as Ce,eZ as We,aY as K,eN as Z,ff as Y,kz as je,eT as oe,eU as Ke,eR as Ye,jV as Xe,jX as Je,d4 as le,hN as Qe,kj as Ze,lY as et,lZ as tt,s as it,kl as de,l_ as rt,_ as ue,km as st,O as nt,eI as at,J as X,P as ot,aC as ce,cD as lt,l$ as dt,a9 as he}from"./index-02c681c0.js";import{i as ut}from"./CIMResourceManager-dc6894fd.js";import{t as ct,a as ht,o as _e,h as _t,i as ft}from"./Container-eca5ccfd.js";import{i as mt}from"./BufferPool-87654370.js";import{T as B,E as S,S as $}from"./color-2b1e5e11.js";import{g as pt,a as L,h as G,w as A,d as gt,m as vt}from"./WGLContainer-4727e9d1.js";import{L as E}from"./enums-fb086c25.js";import{e as bt,a as W,f as ee}from"./ProgramTemplate-1e065e03.js";import{n as U}from"./programUtils-badc776d.js";import{e as fe,r as xt,t as wt,a as yt,m as Tt,J as Ft,n as Bt,b as Et,c as Ot}from"./MagnifierPrograms-645bcf3a.js";import{d as as,y as os}from"./MagnifierPrograms-645bcf3a.js";import{h as te,E as C,a as ie,i as Rt}from"./FramebufferObject-e38d036e.js";import{R as v,E as H,F as re,O as j,I as J,L as D,C as me,D as O,B as se,G as T,U as ne,P as Pt}from"./enums-bdecffa2.js";import{o as pe,N as Mt}from"./RenderingContext-b89520ce.js";import{z as Ct,q as St,Q as At,E as Dt,F as zt,L as N,M as It,_ as Se,R as ge}from"./definitions-4480d7fd.js";import{t as ve}from"./VertexElementDescriptor-2925c6af.js";import{e as R,T as k}from"./Texture-1b4066a3.js";import{s as Ut}from"./imageUtils-4786de20.js";import{r as ds}from"./GraphicsView2D-90c3316c.js";import{i as cs}from"./GraphicContainer-dce81dda.js";import{t as be}from"./requestImageUtils-d9eacbde.js";import"./fontUtils-3230e182.js";import"./AttributeStoreView-b89ca54b.js";import"./TiledDisplayObject-118171af.js";import"./visualVariablesUtils-93bf5328.js";import"./cimAnalyzer-e9c96a3f.js";import"./BidiEngine-9a40f2f4.js";import"./labelPoint-81679f56.js";import"./OptimizedGeometry-196224d4.js";import"./GeometryUtils-984e8446.js";import"./enums-f1a6a48a.js";import"./alignmentUtils-ae955d28.js";import"./number-e491b09e.js";import"./Rect-ea14f53a.js";import"./quantizationUtils-7af70b12.js";import"./floatRGBA-3e3c4332.js";import"./GeometryUtils-8461dbec.js";import"./ExpandedCIM-c0daba92.js";import"./util-4a84bdd4.js";import"./StyleDefinition-29c49b98.js";import"./config-1337d16e.js";import"./earcut-c210587c.js";import"./featureConversionUtils-6032b3c7.js";import"./OptimizedFeature-e90b69df.js";import"./OptimizedFeatureSet-1d1ac4b9.js";import"./NestedMap-1b5db22e.js";import"./Rasterizer-884ce6aa.js";import"./rasterizingUtils-fce63b92.js";import"./pbf-aae2126d.js";import"./imageutils-5815da9d.js";import"./Matcher-4095b6d3.js";import"./tileUtils-c2f19f52.js";import"./TurboLine-66548d29.js";import"./CircularArray-ef508845.js";import"./testSVGPremultipliedAlpha-0e0bc8ed.js";import"./throttle-7bf02de9.js";import"./ComputedAttributeStorage-9e3bcece.js";import"./TimeOnly-ce855a46.js";import"./OrderIndependentTransparency-6ae10952.js";import"./basicInterfaces-11f56cb3.js";import"./doublePrecisionUtils-e3c3d0d8.js";import"./normalizeUtilsSync-86786104.js";import"./projectionSupport-f2ce251f.js";import"./json-48e3ea08.js";import"./BaseGraphicContainer-7c7d8bce.js";import"./FeatureContainer-8f8ae1e7.js";import"./TileContainer-f4960bd1.js";import"./vec3f32-2da9db36.js";let $t=class{constructor(e){this.events=new Ie,this._hasMajorPerformanceCaveat=!1,this._lastRenderFrameCounter=0,this._canvas=document.createElement("canvas"),this._canvas.setAttribute("style","width: 100%; height:100%; display:block; willChange:transform");const t={failIfMajorPerformanceCaveat:!0,alpha:!0,antialias:!1,depth:!0,stencil:!0};e.appendChild(this._canvas);let i=ae("2d",this._canvas,t);i||(i=ae("2d",this._canvas,{...t,failIfMajorPerformanceCaveat:!1}),this._hasMajorPerformanceCaveat=!0),this._gl=i,this._handles=Ue([$e(this._canvas,"webglcontextlost",r=>this.events.emit("webgl-context-lost",r))])}destroy(){var e;(e=this._canvas.parentNode)==null||e.removeChild(this._canvas),this._canvas=null,this._handles.remove(),this._gl=null}get gl(){return this._gl}render(e,t){if(this._hasMajorPerformanceCaveat||q("esri-force-performance-mode")){if(++this._lastRenderFrameCounter>=q("esri-performance-mode-frames-between-render")&&(t(),this._lastRenderViewState=e.state.clone(),this._lastRenderFrameCounter=0),this._lastRenderViewState){const[i,r,n,s,a,o]=this._computeViewTransform(this._lastRenderViewState,e.state);this._canvas.style.transform=`matrix(${i}, ${r}, ${n}, ${s}, ${a}, ${o})`}}else t()}resize(e){const t=this._canvas,i=t.style,{state:{size:r},pixelRatio:n}=e,s=r[0],a=r[1],o=Math.round(s*n),d=Math.round(a*n);t.width===o&&t.height===d||(t.width=o,t.height=d),i.width=s+"px",i.height=a+"px"}_computeViewTransform(e,t){const[i,r]=e.center,[n,s]=t.center,[a,o]=e.toScreen([0,0],n,s),[d,u]=e.toScreen([0,0],i,r),c=d-a,_=u-o,m=e.scale/t.scale,g=t.rotation-e.rotation,f=Ge();return ke(f),Le(f,f,[m,m]),Ne(f,f,He(g)),qe(f,f,[c,_]),f}};const kt={background:{"background.frag":`#ifdef PATTERN
