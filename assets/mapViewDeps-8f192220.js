import{gc as Ie,lS as ae,eL as Ue,h9 as $e,a1 as q,lT as ke,lU as Le,lV as Ne,id as He,lW as qe,lX as Ge,eN as x,ay as Ve,aM as Me,T as Ce,eY as We,b0 as K,eM as Z,fb as Y,kz as je,eS as oe,eT as Ke,eQ as Ye,jV as Xe,jX as Qe,c$ as le,hN as Je,kj as Ze,lY as et,lZ as tt,s as it,kl as de,l_ as rt,_ as ue,km as st,O as nt,eH as at,J as X,P as ot,aG as ce,cy as lt,l$ as dt,ad as he}from"./index-7adde551.js";import{i as ut}from"./CIMResourceManager-509c6324.js";import{t as ct,a as ht,o as _e,h as _t,i as ft}from"./Container-032ab529.js";import{i as mt}from"./BufferPool-3eb3768d.js";import{T as B,E as S,S as $}from"./color-b5a0d054.js";import{g as pt,a as L,h as G,w as A,d as gt,m as vt}from"./WGLContainer-c7efde00.js";import{L as E}from"./enums-fb086c25.js";import{e as bt,a as W,f as ee}from"./ProgramTemplate-135ae0c6.js";import{n as U}from"./programUtils-855e7589.js";import{e as fe,r as xt,t as wt,a as yt,m as Tt,J as Ft,n as Bt,b as Et,c as Ot}from"./MagnifierPrograms-5e4f5fba.js";import{d as as,y as os}from"./MagnifierPrograms-5e4f5fba.js";import{h as te,E as C,a as ie,i as Rt}from"./FramebufferObject-f1ce357a.js";import{R as v,E as H,F as re,O as j,I as Q,L as D,C as me,D as O,B as se,G as T,U as ne,P as Pt}from"./enums-bdecffa2.js";import{o as pe,N as Mt}from"./RenderingContext-3af34c79.js";import{z as Ct,q as St,Q as At,E as Dt,F as zt,L as N,M as It,_ as Se,R as ge}from"./definitions-018a576d.js";import{t as ve}from"./VertexElementDescriptor-2925c6af.js";import{e as R,T as k}from"./Texture-e3ee6469.js";import{s as Ut}from"./imageUtils-2cf82e4a.js";import{r as ds}from"./GraphicsView2D-27fa6649.js";import{i as cs}from"./GraphicContainer-55adb3cb.js";import{t as be}from"./requestImageUtils-6ff186fc.js";import"./fontUtils-889df40f.js";import"./AttributeStoreView-4887340a.js";import"./TiledDisplayObject-229d9f82.js";import"./visualVariablesUtils-3c8647a5.js";import"./cimAnalyzer-8e3e5a7f.js";import"./BidiEngine-9a40f2f4.js";import"./labelPoint-a5c58509.js";import"./OptimizedGeometry-196224d4.js";import"./GeometryUtils-984e8446.js";import"./enums-f1a6a48a.js";import"./alignmentUtils-ae955d28.js";import"./number-e491b09e.js";import"./Rect-ea14f53a.js";import"./quantizationUtils-c03207f7.js";import"./floatRGBA-709d6df7.js";import"./GeometryUtils-36456a6c.js";import"./ExpandedCIM-58625c8e.js";import"./util-767b3041.js";import"./StyleDefinition-29c49b98.js";import"./config-1337d16e.js";import"./earcut-e62884da.js";import"./featureConversionUtils-cfd059b2.js";import"./OptimizedFeature-e90b69df.js";import"./OptimizedFeatureSet-1d1ac4b9.js";import"./NestedMap-1b5db22e.js";import"./Rasterizer-28756a1c.js";import"./rasterizingUtils-82211441.js";import"./pbf-da97ff17.js";import"./imageutils-9d507888.js";import"./Matcher-2ff1805e.js";import"./tileUtils-c2f19f52.js";import"./TurboLine-c36db841.js";import"./CircularArray-ef508845.js";import"./testSVGPremultipliedAlpha-cbc15373.js";import"./throttle-7bf02de9.js";import"./ComputedAttributeStorage-7db7e7a2.js";import"./TimeOnly-69bd546d.js";import"./OrderIndependentTransparency-6ae10952.js";import"./basicInterfaces-11f56cb3.js";import"./doublePrecisionUtils-e3c3d0d8.js";import"./normalizeUtilsSync-952e8b56.js";import"./projectionSupport-38df219b.js";import"./json-48e3ea08.js";import"./BaseGraphicContainer-ec8b1eb8.js";import"./FeatureContainer-f9f61e31.js";import"./TileContainer-f256eff4.js";import"./vec3f32-2da9db36.js";let $t=class{constructor(e){this.events=new Ie,this._hasMajorPerformanceCaveat=!1,this._lastRenderFrameCounter=0,this._canvas=document.createElement("canvas"),this._canvas.setAttribute("style","width: 100%; height:100%; display:block; willChange:transform");const t={failIfMajorPerformanceCaveat:!0,alpha:!0,antialias:!1,depth:!0,stencil:!0};e.appendChild(this._canvas);let i=ae("2d",this._canvas,t);i||(i=ae("2d",this._canvas,{...t,failIfMajorPerformanceCaveat:!1}),this._hasMajorPerformanceCaveat=!0),this._gl=i,this._handles=Ue([$e(this._canvas,"webglcontextlost",r=>this.events.emit("webgl-context-lost",r))])}destroy(){var e;(e=this._canvas.parentNode)==null||e.removeChild(this._canvas),this._canvas=null,this._handles.remove(),this._gl=null}get gl(){return this._gl}render(e,t){if(this._hasMajorPerformanceCaveat||q("esri-force-performance-mode")){if(++this._lastRenderFrameCounter>=q("esri-performance-mode-frames-between-render")&&(t(),this._lastRenderViewState=e.state.clone(),this._lastRenderFrameCounter=0),this._lastRenderViewState){const[i,r,n,s,a,o]=this._computeViewTransform(this._lastRenderViewState,e.state);this._canvas.style.transform=`matrix(${i}, ${r}, ${n}, ${s}, ${a}, ${o})`}}else t()}resize(e){const t=this._canvas,i=t.style,{state:{size:r},pixelRatio:n}=e,s=r[0],a=r[1],o=Math.round(s*n),d=Math.round(a*n);t.width===o&&t.height===d||(t.width=o,t.height=d),i.width=s+"px",i.height=a+"px"}_computeViewTransform(e,t){const[i,r]=e.center,[n,s]=t.center,[a,o]=e.toScreen([0,0],n,s),[d,u]=e.toScreen([0,0],i,r),c=d-a,_=u-o,m=e.scale/t.scale,g=t.rotation-e.rotation,f=Ge();return ke(f),Le(f,f,[m,m]),Ne(f,f,He(g)),qe(f,f,[c,_]),f}};const kt={background:{"background.frag":`#ifdef PATTERN
