import{gd as Ie,lS as ae,eM as Ue,h9 as $e,a1 as q,lT as ke,lU as Le,lV as Ne,id as He,lW as qe,lX as Ge,eO as x,ay as Ve,aM as Me,T as Ce,eZ as We,b0 as K,eN as Z,fc as X,kz as je,eT as oe,eU as Ke,eR as Xe,jV as Ye,jX as Je,d4 as le,hN as Qe,kj as Ze,lY as et,lZ as tt,s as it,kl as de,l_ as rt,_ as ue,km as st,O as nt,eI as at,J as Y,P as ot,aG as ce,cD as lt,l$ as dt,ad as he}from"./index-e88387f3.js";import{i as ut}from"./CIMResourceManager-69f137a2.js";import{t as ct,a as ht,o as _e,h as _t,i as ft}from"./Container-36c05c87.js";import{i as mt}from"./BufferPool-dabc0029.js";import{T as B,E as S,S as $}from"./color-10797745.js";import{g as pt,a as L,h as G,w as A,d as gt,m as vt}from"./WGLContainer-dd32c3b7.js";import{L as E}from"./enums-fb086c25.js";import{e as bt,a as W,f as ee}from"./ProgramTemplate-da7f9006.js";import{n as U}from"./programUtils-fdf361fb.js";import{e as fe,r as xt,t as wt,a as yt,m as Tt,J as Ft,n as Bt,b as Et,c as Ot}from"./MagnifierPrograms-a7f1420b.js";import{d as as,y as os}from"./MagnifierPrograms-a7f1420b.js";import{h as te,E as C,a as ie,i as Rt}from"./FramebufferObject-ed33cce4.js";import{R as v,E as H,F as re,O as j,I as J,L as D,C as me,D as O,B as se,G as T,U as ne,P as Pt}from"./enums-bdecffa2.js";import{o as pe,N as Mt}from"./RenderingContext-f4a9bed7.js";import{z as Ct,q as St,Q as At,E as Dt,F as zt,L as N,M as It,_ as Se,R as ge}from"./definitions-1a0e2008.js";import{t as ve}from"./VertexElementDescriptor-2925c6af.js";import{e as R,T as k}from"./Texture-827b9aaa.js";import{s as Ut}from"./imageUtils-29fd8acb.js";import{r as ds}from"./GraphicsView2D-77e3e981.js";import{i as cs}from"./GraphicContainer-5ec11a8d.js";import{t as be}from"./requestImageUtils-5c3a8f92.js";import"./fontUtils-42144027.js";import"./AttributeStoreView-0568c808.js";import"./TiledDisplayObject-32b04012.js";import"./visualVariablesUtils-00a07529.js";import"./cimAnalyzer-a10249d4.js";import"./BidiEngine-9a40f2f4.js";import"./labelPoint-074eea2c.js";import"./OptimizedGeometry-196224d4.js";import"./GeometryUtils-984e8446.js";import"./enums-f1a6a48a.js";import"./alignmentUtils-ae955d28.js";import"./number-e491b09e.js";import"./Rect-ea14f53a.js";import"./quantizationUtils-a0dc59e7.js";import"./floatRGBA-51fb6cf9.js";import"./GeometryUtils-cf666b71.js";import"./ExpandedCIM-9cfbdbef.js";import"./util-c018a817.js";import"./StyleDefinition-29c49b98.js";import"./config-1337d16e.js";import"./earcut-ee9358e2.js";import"./featureConversionUtils-4c659ed1.js";import"./OptimizedFeature-e90b69df.js";import"./OptimizedFeatureSet-1d1ac4b9.js";import"./NestedMap-1b5db22e.js";import"./Rasterizer-0d3cf423.js";import"./rasterizingUtils-b38c2b26.js";import"./pbf-57b827b0.js";import"./imageutils-2b7efdb2.js";import"./Matcher-5351db63.js";import"./tileUtils-c2f19f52.js";import"./TurboLine-c1ad9b97.js";import"./CircularArray-ef508845.js";import"./testSVGPremultipliedAlpha-9349d7f4.js";import"./throttle-7bf02de9.js";import"./ComputedAttributeStorage-f9415bae.js";import"./TimeOnly-d896b5c5.js";import"./OrderIndependentTransparency-6ae10952.js";import"./basicInterfaces-11f56cb3.js";import"./doublePrecisionUtils-e3c3d0d8.js";import"./normalizeUtilsSync-d3ab1153.js";import"./projectionSupport-ff24c0cb.js";import"./json-48e3ea08.js";import"./BaseGraphicContainer-b74b9457.js";import"./FeatureContainer-1b758af7.js";import"./TileContainer-29f9b11c.js";import"./vec3f32-2da9db36.js";let $t=class{constructor(e){this.events=new Ie,this._hasMajorPerformanceCaveat=!1,this._lastRenderFrameCounter=0,this._canvas=document.createElement("canvas"),this._canvas.setAttribute("style","width: 100%; height:100%; display:block; willChange:transform");const t={failIfMajorPerformanceCaveat:!0,alpha:!0,antialias:!1,depth:!0,stencil:!0};e.appendChild(this._canvas);let i=ae("2d",this._canvas,t);i||(i=ae("2d",this._canvas,{...t,failIfMajorPerformanceCaveat:!1}),this._hasMajorPerformanceCaveat=!0),this._gl=i,this._handles=Ue([$e(this._canvas,"webglcontextlost",r=>this.events.emit("webgl-context-lost",r))])}destroy(){var e;(e=this._canvas.parentNode)==null||e.removeChild(this._canvas),this._canvas=null,this._handles.remove(),this._gl=null}get gl(){return this._gl}render(e,t){if(this._hasMajorPerformanceCaveat||q("esri-force-performance-mode")){if(++this._lastRenderFrameCounter>=q("esri-performance-mode-frames-between-render")&&(t(),this._lastRenderViewState=e.state.clone(),this._lastRenderFrameCounter=0),this._lastRenderViewState){const[i,r,n,s,a,o]=this._computeViewTransform(this._lastRenderViewState,e.state);this._canvas.style.transform=`matrix(${i}, ${r}, ${n}, ${s}, ${a}, ${o})`}}else t()}resize(e){const t=this._canvas,i=t.style,{state:{size:r},pixelRatio:n}=e,s=r[0],a=r[1],o=Math.round(s*n),d=Math.round(a*n);t.width===o&&t.height===d||(t.width=o,t.height=d),i.width=s+"px",i.height=a+"px"}_computeViewTransform(e,t){const[i,r]=e.center,[n,s]=t.center,[a,o]=e.toScreen([0,0],n,s),[d,u]=e.toScreen([0,0],i,r),c=d-a,_=u-o,m=e.scale/t.scale,g=t.rotation-e.rotation,f=Ge();return ke(f),Le(f,f,[m,m]),Ne(f,f,He(g)),qe(f,f,[c,_]),f}};const kt={background:{"background.frag":`#ifdef PATTERN
