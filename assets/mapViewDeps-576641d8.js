import{gc as Ie,lS as ae,eL as Ue,h9 as $e,a1 as q,lT as ke,lU as Le,lV as Ne,id as He,lW as qe,lX as Ge,eN as x,ay as Ve,aM as Me,T as Ce,eY as We,b0 as K,eM as Z,fb as Y,kz as je,eS as oe,eT as Ke,eQ as Ye,jV as Xe,jX as Qe,c$ as le,hN as Je,kj as Ze,lY as et,lZ as tt,s as it,kl as de,l_ as rt,_ as ue,km as st,O as nt,eH as at,J as X,P as ot,aG as ce,cy as lt,l$ as dt,ad as he}from"./index-c6695971.js";import{i as ut}from"./CIMResourceManager-6608ddf7.js";import{t as ct,a as ht,o as _e,h as _t,i as ft}from"./Container-93cb5e61.js";import{i as mt}from"./BufferPool-a9f0df71.js";import{T as B,E as S,S as $}from"./color-f425d42f.js";import{g as pt,a as L,h as G,w as A,d as gt,m as vt}from"./WGLContainer-e5e88cfb.js";import{L as E}from"./enums-fb086c25.js";import{e as bt,a as W,f as ee}from"./ProgramTemplate-80f612c6.js";import{n as U}from"./programUtils-85fd5861.js";import{e as fe,r as xt,t as wt,a as yt,m as Tt,J as Ft,n as Bt,b as Et,c as Ot}from"./MagnifierPrograms-5b5d1249.js";import{d as as,y as os}from"./MagnifierPrograms-5b5d1249.js";import{h as te,E as C,a as ie,i as Rt}from"./FramebufferObject-84a7c94e.js";import{R as v,E as H,F as re,O as j,I as Q,L as D,C as me,D as O,B as se,G as T,U as ne,P as Pt}from"./enums-bdecffa2.js";import{o as pe,N as Mt}from"./RenderingContext-21848a0b.js";import{z as Ct,q as St,Q as At,E as Dt,F as zt,L as N,M as It,_ as Se,R as ge}from"./definitions-ed2e37ce.js";import{t as ve}from"./VertexElementDescriptor-2925c6af.js";import{e as R,T as k}from"./Texture-a461518b.js";import{s as Ut}from"./imageUtils-52d23f2e.js";import{r as ds}from"./GraphicsView2D-3cf372a8.js";import{i as cs}from"./GraphicContainer-e98d51a3.js";import{t as be}from"./requestImageUtils-a93ce298.js";import"./fontUtils-32d528cc.js";import"./AttributeStoreView-665d97d7.js";import"./TiledDisplayObject-bcb62d40.js";import"./visualVariablesUtils-936869a9.js";import"./cimAnalyzer-0169f904.js";import"./BidiEngine-9a40f2f4.js";import"./labelPoint-c2a0bf0f.js";import"./OptimizedGeometry-196224d4.js";import"./GeometryUtils-984e8446.js";import"./enums-f1a6a48a.js";import"./alignmentUtils-ae955d28.js";import"./number-e491b09e.js";import"./Rect-ea14f53a.js";import"./quantizationUtils-a9ac201b.js";import"./floatRGBA-6b13f7b5.js";import"./GeometryUtils-4074f16a.js";import"./ExpandedCIM-4cb0e22a.js";import"./util-7b3c1d9b.js";import"./StyleDefinition-29c49b98.js";import"./config-1337d16e.js";import"./earcut-feb8eaa1.js";import"./featureConversionUtils-b14354fa.js";import"./OptimizedFeature-e90b69df.js";import"./OptimizedFeatureSet-1d1ac4b9.js";import"./NestedMap-1b5db22e.js";import"./Rasterizer-c1e77292.js";import"./rasterizingUtils-82ff2311.js";import"./pbf-25e25f37.js";import"./imageutils-9aa9e38b.js";import"./Matcher-f4857fcb.js";import"./tileUtils-c2f19f52.js";import"./TurboLine-9cb3b398.js";import"./CircularArray-ef508845.js";import"./testSVGPremultipliedAlpha-de7c5441.js";import"./throttle-7bf02de9.js";import"./ComputedAttributeStorage-5198f934.js";import"./TimeOnly-913c42d5.js";import"./OrderIndependentTransparency-6ae10952.js";import"./basicInterfaces-11f56cb3.js";import"./doublePrecisionUtils-e3c3d0d8.js";import"./normalizeUtilsSync-18a905fb.js";import"./projectionSupport-b442cf90.js";import"./json-48e3ea08.js";import"./BaseGraphicContainer-9dda91b0.js";import"./FeatureContainer-f9f4ee7b.js";import"./TileContainer-9654c1b7.js";import"./vec3f32-2da9db36.js";let $t=class{constructor(e){this.events=new Ie,this._hasMajorPerformanceCaveat=!1,this._lastRenderFrameCounter=0,this._canvas=document.createElement("canvas"),this._canvas.setAttribute("style","width: 100%; height:100%; display:block; willChange:transform");const t={failIfMajorPerformanceCaveat:!0,alpha:!0,antialias:!1,depth:!0,stencil:!0};e.appendChild(this._canvas);let i=ae("2d",this._canvas,t);i||(i=ae("2d",this._canvas,{...t,failIfMajorPerformanceCaveat:!1}),this._hasMajorPerformanceCaveat=!0),this._gl=i,this._handles=Ue([$e(this._canvas,"webglcontextlost",r=>this.events.emit("webgl-context-lost",r))])}destroy(){var e;(e=this._canvas.parentNode)==null||e.removeChild(this._canvas),this._canvas=null,this._handles.remove(),this._gl=null}get gl(){return this._gl}render(e,t){if(this._hasMajorPerformanceCaveat||q("esri-force-performance-mode")){if(++this._lastRenderFrameCounter>=q("esri-performance-mode-frames-between-render")&&(t(),this._lastRenderViewState=e.state.clone(),this._lastRenderFrameCounter=0),this._lastRenderViewState){const[i,r,n,s,a,o]=this._computeViewTransform(this._lastRenderViewState,e.state);this._canvas.style.transform=`matrix(${i}, ${r}, ${n}, ${s}, ${a}, ${o})`}}else t()}resize(e){const t=this._canvas,i=t.style,{state:{size:r},pixelRatio:n}=e,s=r[0],a=r[1],o=Math.round(s*n),d=Math.round(a*n);t.width===o&&t.height===d||(t.width=o,t.height=d),i.width=s+"px",i.height=a+"px"}_computeViewTransform(e,t){const[i,r]=e.center,[n,s]=t.center,[a,o]=e.toScreen([0,0],n,s),[d,u]=e.toScreen([0,0],i,r),c=d-a,_=u-o,m=e.scale/t.scale,g=t.rotation-e.rotation,f=Ge();return ke(f),Le(f,f,[m,m]),Ne(f,f,He(g)),qe(f,f,[c,_]),f}};const kt={background:{"background.frag":`#ifdef PATTERN
