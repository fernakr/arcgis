import{gc as Ie,lS as ae,eL as Ue,h9 as $e,a1 as q,lT as ke,lU as Le,lV as Ne,id as He,lW as qe,lX as Ge,eN as x,ay as Ve,aM as Me,T as Ce,eY as We,b0 as K,eM as Z,fb as Y,kz as je,eS as oe,eT as Ke,eQ as Ye,jV as Xe,jX as Qe,c$ as le,hN as Je,kj as Ze,lY as et,lZ as tt,s as it,kl as de,l_ as rt,_ as ue,km as st,O as nt,eH as at,J as X,P as ot,aG as ce,cy as lt,l$ as dt,ad as he}from"./index-cdf69f36.js";import{i as ut}from"./CIMResourceManager-01cbfb84.js";import{t as ct,a as ht,o as _e,h as _t,i as ft}from"./Container-7bafc118.js";import{i as mt}from"./BufferPool-8e715b15.js";import{T as B,E as S,S as $}from"./color-9054a86e.js";import{g as pt,a as L,h as G,w as A,d as gt,m as vt}from"./WGLContainer-e978ac2e.js";import{L as E}from"./enums-fb086c25.js";import{e as bt,a as W,f as ee}from"./ProgramTemplate-b0743a30.js";import{n as U}from"./programUtils-e1267d0b.js";import{e as fe,r as xt,t as wt,a as yt,m as Tt,J as Ft,n as Bt,b as Et,c as Ot}from"./MagnifierPrograms-92c93634.js";import{d as as,y as os}from"./MagnifierPrograms-92c93634.js";import{h as te,E as C,a as ie,i as Rt}from"./FramebufferObject-32003335.js";import{R as v,E as H,F as re,O as j,I as Q,L as D,C as me,D as O,B as se,G as T,U as ne,P as Pt}from"./enums-bdecffa2.js";import{o as pe,N as Mt}from"./RenderingContext-d76583db.js";import{z as Ct,q as St,Q as At,E as Dt,F as zt,L as N,M as It,_ as Se,R as ge}from"./definitions-eba50215.js";import{t as ve}from"./VertexElementDescriptor-2925c6af.js";import{e as R,T as k}from"./Texture-4ee49a9f.js";import{s as Ut}from"./imageUtils-eba8e99d.js";import{r as ds}from"./GraphicsView2D-e6e73c89.js";import{i as cs}from"./GraphicContainer-3cba5165.js";import{t as be}from"./requestImageUtils-54f212df.js";import"./fontUtils-51011e9c.js";import"./AttributeStoreView-49c0d98e.js";import"./TiledDisplayObject-a41da2a0.js";import"./visualVariablesUtils-77f475fd.js";import"./cimAnalyzer-b1f151f7.js";import"./BidiEngine-9a40f2f4.js";import"./labelPoint-0c908705.js";import"./OptimizedGeometry-196224d4.js";import"./GeometryUtils-984e8446.js";import"./enums-f1a6a48a.js";import"./alignmentUtils-ae955d28.js";import"./number-e491b09e.js";import"./Rect-ea14f53a.js";import"./quantizationUtils-73ecda2d.js";import"./floatRGBA-b8cf594d.js";import"./GeometryUtils-fd0f8ba8.js";import"./ExpandedCIM-eb3c19b3.js";import"./util-4c6b6efd.js";import"./StyleDefinition-29c49b98.js";import"./config-1337d16e.js";import"./earcut-adc00ba5.js";import"./featureConversionUtils-e1010ffb.js";import"./OptimizedFeature-e90b69df.js";import"./OptimizedFeatureSet-1d1ac4b9.js";import"./NestedMap-1b5db22e.js";import"./Rasterizer-80913534.js";import"./rasterizingUtils-3fc5a9a5.js";import"./pbf-9729a88e.js";import"./imageutils-078f8f46.js";import"./Matcher-54cdf8cb.js";import"./tileUtils-c2f19f52.js";import"./TurboLine-3e8d96d3.js";import"./CircularArray-ef508845.js";import"./testSVGPremultipliedAlpha-f9380754.js";import"./throttle-7bf02de9.js";import"./ComputedAttributeStorage-2de69fcc.js";import"./TimeOnly-13c8eb6e.js";import"./OrderIndependentTransparency-6ae10952.js";import"./basicInterfaces-11f56cb3.js";import"./doublePrecisionUtils-e3c3d0d8.js";import"./normalizeUtilsSync-17e15a73.js";import"./projectionSupport-5251d30a.js";import"./json-48e3ea08.js";import"./BaseGraphicContainer-5bfc1842.js";import"./FeatureContainer-e27574d8.js";import"./TileContainer-22451a4c.js";import"./vec3f32-2da9db36.js";let $t=class{constructor(e){this.events=new Ie,this._hasMajorPerformanceCaveat=!1,this._lastRenderFrameCounter=0,this._canvas=document.createElement("canvas"),this._canvas.setAttribute("style","width: 100%; height:100%; display:block; willChange:transform");const t={failIfMajorPerformanceCaveat:!0,alpha:!0,antialias:!1,depth:!0,stencil:!0};e.appendChild(this._canvas);let i=ae("2d",this._canvas,t);i||(i=ae("2d",this._canvas,{...t,failIfMajorPerformanceCaveat:!1}),this._hasMajorPerformanceCaveat=!0),this._gl=i,this._handles=Ue([$e(this._canvas,"webglcontextlost",r=>this.events.emit("webgl-context-lost",r))])}destroy(){var e;(e=this._canvas.parentNode)==null||e.removeChild(this._canvas),this._canvas=null,this._handles.remove(),this._gl=null}get gl(){return this._gl}render(e,t){if(this._hasMajorPerformanceCaveat||q("esri-force-performance-mode")){if(++this._lastRenderFrameCounter>=q("esri-performance-mode-frames-between-render")&&(t(),this._lastRenderViewState=e.state.clone(),this._lastRenderFrameCounter=0),this._lastRenderViewState){const[i,r,n,s,a,o]=this._computeViewTransform(this._lastRenderViewState,e.state);this._canvas.style.transform=`matrix(${i}, ${r}, ${n}, ${s}, ${a}, ${o})`}}else t()}resize(e){const t=this._canvas,i=t.style,{state:{size:r},pixelRatio:n}=e,s=r[0],a=r[1],o=Math.round(s*n),d=Math.round(a*n);t.width===o&&t.height===d||(t.width=o,t.height=d),i.width=s+"px",i.height=a+"px"}_computeViewTransform(e,t){const[i,r]=e.center,[n,s]=t.center,[a,o]=e.toScreen([0,0],n,s),[d,u]=e.toScreen([0,0],i,r),c=d-a,_=u-o,m=e.scale/t.scale,g=t.rotation-e.rotation,f=Ge();return ke(f),Le(f,f,[m,m]),Ne(f,f,He(g)),qe(f,f,[c,_]),f}};const kt={background:{"background.frag":`#ifdef PATTERN
